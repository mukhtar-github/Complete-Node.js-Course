...
*get* method, we need to specify a path. So that should be */api/courses*. Because we're going to post to the collection of courses, that's why we use the plural name. Then we add our *route handler*. So request and response goes to code block.
