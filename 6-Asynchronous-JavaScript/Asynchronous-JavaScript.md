...
So let's run this application and see what happens. So *node exercise.js*. So, it takes about 4 seconds to get a customer, I change the timeout so you can see more clearly. Here is our customer object, then we get the top movies,and finally,
