...
Alright now, let's add a new file here, *index.js*. The first thing we need to, is to connect to *MongoDB*. So, we load, this *mongoose* module, and store it in this constant *mongoose*.
