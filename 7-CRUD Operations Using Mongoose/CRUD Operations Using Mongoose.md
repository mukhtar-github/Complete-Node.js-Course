...
So we have *name*, which should be a string, *author* which is also a string, *tags* which is an array of strings, we have *date* which is a date object, we have *isPublished* which is boolean. And finally *price*
