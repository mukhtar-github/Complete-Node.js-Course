...
And finally, we need to pick only *name* and *author* properties. So, *select()* and pass an object with two properties, *name* we set this to 1, and *author* sets to 1 as well.
